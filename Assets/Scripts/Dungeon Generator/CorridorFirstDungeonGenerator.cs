...
public class CorridorFirstDungeonGenerator : SimpleRandomWalkGenerator
{
    ...
    private void CorridorFirstGeneration()
    {
        ...
        {
            corridors[i] = IncreaseCorridorSizeOneByOne(corridors[i]);
            // corridors[i] = IncreaseCorridorBrushThreeByThree(corridors[i]);
    ...
    private List<Vector2Int> IncreaseCorridorBrushThreeByThree(List<Vector2Int> corridor)
    {
    ...
    private List<Vector2Int> IncreaseCorridorSizeOneByOne(List<Vector2Int> corridor)
    {
        List<Vector2Int> newCorridor = new List<Vector2Int>();
